export const experiences = [
  {
    ...
    title:
      "Mia just finished Session 1.",

    label:
      "Today at The Little Nest",

    copy:
      "Letter A, Number 1, movement, listening and self-expression were all part of her morning.",
    ...
    deeper:
      "Session 1 introduces Letter A and Number 1 while weaving in movement, listening, speaking and personal development. This is curriculum truth: we know Mia attended this session and these were the learning opportunities built into it.",
